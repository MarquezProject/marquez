...
You will then need to set the following environment variables (we recommend adding them to your `.bashrc`): `POSTGRES_DB_NAME`, `POSTGRES_USER`, and `POSTGRES_PASSWORD`.
