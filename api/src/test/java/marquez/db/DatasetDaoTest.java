    ...
    createLineageRow(
        ...
        Collections.singletonList(
            ol.newOutputDataset(
                ...
                newDatasetFacet(
                    ImmutableMap.of("writeFacet", new CustomValueFacet("secondWriteValue")),
                    ol.newSchemaDatasetFacetFields("age", "int", "the age"),
                    ol.newSchemaDatasetFacetFields("address", "string", "the address")),
                null)));
