...
@Slf4j
public class V55_BackfillFacetsPerformanceTest {
  ...
  public static void setUpOnce(Jdbi jdbi) {
    V55_BackfillFacetsPerformanceTest.jdbi = jdbi;
  ...
  public void testMigration() throws Exception {
    ...
    subject.setTriggeredByCommand(true);
  ...
  private void clearFacetsTablesAndLock() {
    Arrays.asList(
            ...
            "DELETE FROM v55_facet_migration_lock")
        .stream()
