CREATE MATERIALIZED VIEW IF NOT EXISTS lineage_metrics_hourly AS
...
CREATE INDEX IF NOT EXISTS idx_metrics_hourly_start_interval
    ON lineage_metrics_hourly (start_interval);

CREATE MATERIALIZED VIEW IF NOT EXISTS lineage_metrics_daily AS
...
CREATE INDEX IF NOT EXISTS idx_metrics_daily_start_interval
    ON lineage_metrics_daily (start_interval);
