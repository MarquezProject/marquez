...
import marquez.api.LifecycleResource;
...
public final class MarquezContext {
  ...
  @Getter private final LifecycleDao lifecycleDao;
  ...
  @Getter private final LifecycleService lifecycleService;
  ...
  @Getter private final LifecycleResource lifecycleResource;
  ...
  private MarquezContext(
    ...
    this.lifecycleDao = jdbi.onDemand(LifecycleDao.class);
    ...
    this.lifecycleService = new LifecycleService(lifecycleDao);
    this.jobService = new JobService(baseDao, runService);
    this.tagService = new TagService(baseDao);
    this.tagService.init(tags);
    this.openLineageService = new OpenLineageService(baseDao, runService, lifecycleService);
    ...
    this.lifecycleResource = new LifecycleResource(lifecycleDao);
