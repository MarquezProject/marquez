...
from marquez_airflow.extractors.mysql_extractor import MySqlExtractor

CONN_ID = 'food_delivery_db'
CONN_URI = 'mysql://localhost:5432/food_delivery'
...
@mock.patch('marquez_airflow.extractors.mysql_extractor.\
MySqlExtractor._get_table_schemas')
def test_extract(mock_get_table_schemas):
    ...
    step_metadata = MySqlExtractor(TASK).extract()
