...
IF_NOT_EXISTS_TASK_ID = 'bigquery_if_not_exists'
INSERT_TASK_ID = 'bigquery_insert'
...
# DATASETS
IN_TABLE_NAME = f'{PROJECT_ID}.{DATASET_ID}.top_delivery_times'
IN_TABLE_PHYSICAL_NAME = IN_TABLE_NAME
OUT_TABLE_NAME = f'{PROJECT_ID}.{DATASET_ID}.popular_orders_day_of_week'
...
def check_jobs_meta():
    ...
    # TODO: filtering? Referenced tables contain output table
