...
from marquez_airflow.dag import _EXTRACTORS as DAG_EXTRACTORS
...
def test_marquez_dag_with_extractor(mock_get_or_create_marquez_client,
    ...
    DAG_EXTRACTORS[task_will_complete.__class__] = TestFixtureDummyExtractor
...
def test_marquez_dag_with_extract_on_complete(
    ...
    # Add the dummy extractor to the list for the task above
    DAG_EXTRACTORS[task_will_complete.__class__] = \
