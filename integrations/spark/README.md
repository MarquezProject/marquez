...
```groovy
implementation 'io.github.marquezproject:marquez-spark:0.15.2-rc.1
```
...
spark = (SparkSession.builder.master('local')
         ...
         .config('spark.jars.packages', 'io.github.marquezproject:marquez-spark:0.15.2-rc.1
...
t1 = DataProcPySparkOperator(
    ...
    dataproc_pyspark_properties={
      ...
      "spark.jars.packages": "io.github.marquezproject:marquez-spark:0.15.2-rc.1
