...
To start Marquez with sample metadata that will be used and referenced in the next section, run the following command from the base of the Marquez repository:
