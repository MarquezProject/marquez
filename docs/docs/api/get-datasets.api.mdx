          ...
          "schema":
            {
              ...
              "default": "name",
              "example": "name",
              "description": "Orders the results of your query by indicated `sortDirection` by any column on the row.",
            },
          "required": false,
        },
        {
          ...
          "schema":
            {
              ...
              "type": "string",
              "example": "etl",
              "description": "Filters the results of your query by indicated pattern. Matches any substring",
            },
          "required": false,
        },
        {
    ...
    "postman":
      {
        ...
        "description":
          { "content": "Returns a list of datasets.", "type": "text/plain" },
        "url":
          {
            "path": ["namespaces", ":namespace", "datasets"],
            "host": ["{{baseUrl}}"],
            "query":
              [
                { "disabled": false, "key": "orderBy", "value": "" },
                { "disabled": false, "key": "sortDirection", "value": "" },
                { "disabled": false, "key": "pattern", "value": "" },
                {
                  "disabled": false,
                  "description":
                    {
