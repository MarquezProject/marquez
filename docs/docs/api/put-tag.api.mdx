...
api:
  {
                ...
                "schema":
                  {
                    ...
                    "example": { "description": "My first tag!" },
                    "title": "CreatedTag",
                  },
              },
          },
      ...
      [
        {
          ...
          "description": "The name of the tag.",
          "required": true,
          "schema": { "type": "string", "example": "SENSITIVE" },
        },
      ],
    "method": "put",
    "path": "/tags/{tag}",
    ...
    "jsonRequestBodyExample": { "description": "My first tag!" },
    "info":
      {
        "title": "Marquez",
        "version": "0.50.0",
    ...
    "postman":
      {
        "name": "Create a tag",
        "description":
          { "content": "Creates a new tag object.", "type": "text/plain" },
        "url":
          {
            "path": ["tags", ":tag"],
            "host": ["{{baseUrl}}"],
              ...
              [
                {
                  ...
                  "description":
                    {
                      "content": "(Required) The name of the tag.",
                      "type": "text/plain",
                    },
                  "type": "any",
                  "value": "",
