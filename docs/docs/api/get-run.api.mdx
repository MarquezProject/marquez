...
api:
  {
    ...
    "postman":
      {
        "name": "Retrieve a run",
        "description": { "content": "Retrieve a run.", "type": "text/plain" },
        "url":
          {
            "path": ["jobs", "runs", ":id"],
            "host": ["{{baseUrl}}"],
...
<details style={{"marginBottom":"1rem"}} data-collapsed={false} open={true}><summary style={{}}><strong>Path Parameters</strong></summary><div><ul><ParamsItem className={"paramsItem"} param={{"name":"id","in":"path","description":"The ID of the run.","required":true,"schema":{"type":"string","format":"uuid","example":"ea9badc5-7cb2-49af-9a9f-155771d3a797"}}}></ParamsItem></ul></div></details><div><ApiTabs><TabItem label={"200"} value={"200"}><div>
