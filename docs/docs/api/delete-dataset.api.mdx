...
api:
  {
    ...
    "postman":
      {
        "name": "Soft deletes dataset.",
        "description":
          {
            "content": "Soft deletes dataset. It will be un-deleted if new OpenLineage event containing this dataset comes.",
            "type": "text/plain",
          },
        "url":
          {
