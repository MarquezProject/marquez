...
If data in the `airflowsample` table were to arrive late (imagine that), you would need to know about all the upstream dependencies in order to diagnose and resolve the issue efficiently.
