...
export declare class CacheProvider {
     ...
     * @param value
     */
    save(key: string, value: string, callback: (error: null, value: CacheItem) => void): void;
    /**
     * Returns the value of the specified key in the cache
     * @param id
     * @returns {boolean}
     */
    get(key: string, callback: (key: string | null, value: string) => void): void;
    /**
     * Removes an item from the cache if it exists
     * @param key
     */
    remove(key: string, callback: (err: Error | null, key: string) => void): void;
}
export {};
