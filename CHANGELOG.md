...
* API: add endpoint method and path to metrics name [`#2850`](https://github.com/MarquezProject/marquez/pull/2850) [@JDarDagran](https://github.com/JDarDagran)  
    *In metrics endpoint there was information gathered containing the SQL Object name + method name. This introduces labels (DAO name, DAO method, endpoint method, endpoint path) to add more information about endpoints.*
