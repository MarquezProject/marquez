...
public class JobEqualityTest {
    ...
    final private static UUID JOB_UUID = UUID.randomUUID();
    final private static String JOB_NAME = "myJob";
    final private static String OWNER_NAME = "myOwner";
    final private static Timestamp NOMINAL_TIME = Timestamp.from(Instant.now());
    final private static String CATEGORY = "myCategory";
    final private static String DESCRIPTION = "the first job";
    ...
    public void testJobInequalityOnUUID() {
        Job j2 = new Job(UUID.randomUUID(), JOB_NAME, OWNER_NAME,
                NOMINAL_TIME, CATEGORY, DESCRIPTION);
        assertThat(!JOB.equals(j2));
        assertThat(JOB.equals(JOB));
    }
    ...
    public void testJobInequalityOnNonIDField() {
        Job j2 = new Job(JOB_UUID, "some other name", OWNER_NAME,
                NOMINAL_TIME, CATEGORY, DESCRIPTION);
        assertThat(!JOB.equals(j2));
        assertThat(JOB.equals(JOB));
    }
    ...
    public void testJobHashcodeInequalityOnNonIdField() {
        Job j2 = new Job(JOB_UUID, "some other job name", OWNER_NAME,
                NOMINAL_TIME, CATEGORY, DESCRIPTION);
        assertNotEquals(JOB.hashCode(), j2.hashCode());
    }
}
