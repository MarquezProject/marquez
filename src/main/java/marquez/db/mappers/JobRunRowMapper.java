...
import marquez.db.models.JobRunRow;
import org.jdbi.v3.core.mapper.RowMapper;
import org.jdbi.v3.core.statement.StatementContext;

public final class JobRunRowMapper implements RowMapper<JobRunRow> {
  @Override
  public JobRunRow map(@NonNull ResultSet results, @NonNull StatementContext context)
      throws SQLException {
